...
class TransferCurve():
    ...
    def initialize(self, x_address="GPIB0::5::INSTR", y_address="GPIB0::9::INSTR", sm_address="GPIB0::20::INSTR"):
    ...
    def output_on(self, x_on=True, y_on=True, sm_on=True)
        PowerSupply_X.output(x_on)
        PowerSupply_Y.output(y_on)
        SourceMeter.output(sm_on)
